/*
 * tiny-aws-kms-openssl-provider -- provider entry point.
 *
 ...
 * abort at exit with "mutex lock failed" in every host tried, and destroying it
 * in teardown does not help. Everything expensive is created lazily on first
 * use.
 */
#include "provider.h"
...
#define AWSKMS_VERSION "0.0.0-dev"
#endif
