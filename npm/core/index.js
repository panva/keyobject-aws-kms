...
const PLATFORM_PACKAGES = {
  ...
  'darwin-x64': '@keyobject/aws-kms-darwin-x64',
...
function resolveSatelliteFiles() {
  switch (target) {
    ...
    case 'darwin-x64':
      return {
        manifest: require.resolve('@keyobject/aws-kms-darwin-x64/package.json'),
        module: require.resolve('@keyobject/aws-kms-darwin-x64/aws-kms.dylib'),
        config: require.resolve('@keyobject/aws-kms-darwin-x64/awskms.cnf'),
      };
    case 'linux-arm64':
      return {
